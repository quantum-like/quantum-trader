...
import sys
MODEL_TYPE = sys.argv[1] if len(sys.argv) > 1 else "nn"
# choose: "xgb", "rf", "extra_trees", "ridge", "lgbm", "nn"
...
def save_feature_importance_plot():
    if feature_importance["importance"].isna().all():
        return
